...
parser.add_argument('--data_dir', default='/home/venkatesh/Venk_Impl_VOC/VOC/', help="Directory with the SIGNS dataset")
parser.add_argument('--output_dir', default='/home/venkatesh/Venk_Impl_VOC/split-data', help="Where to write the new data")
...
if __name__ == '__main__':
    ...
    train_data_dir = os.path.join(args.data_dir, 'VOC_Segmentation')
