...
class DataQueue:
    #---------------------------------------------------------------------------
    def __init__(self, img_template, label_template, maxsize, img_seg_gt_template):
        #-----------------------------------------------------------------------
        ...
        self.image_gt_seg_dtype = img_seg_gt_template.dtype
        self.image_gt_seg_shape = img_seg_gt_template.shape
        self.image_gt_seg_bc = len(img_seg_gt_template.tobytes())
        ...
        for i in range(maxsize):
            ...
            img_seg_gt_buff= mp.Array('c', self.image_gt_seg_bc, lock= False)
            img_seg_arr = np.frombuffer(img_seg_gt_buff, dtype=self.image_gt_seg_dtype)
            img_seg_arr = img_seg_arr.reshape(self.image_gt_seg_shape)

            self.array_pool.append((img_arr, label_arr, img_seg_arr))
